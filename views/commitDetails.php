<?php
	...
	echo "
		<h2>Commit ID :$_SESSION[version]</h2>\n
		<h3>Committed on $row[Date]</h3>\n
		Commit Message:\n
		$commitMessage<br>\n
		<a href=../controllers/gitCommands/checkoutDownload.php?version=$_SESSION[version]>\n
			<input type=submit value='Download This Version' style=height:25px>\n
		</a>\n
		<a href=branch.php?version=$_SESSION[version]>\n
